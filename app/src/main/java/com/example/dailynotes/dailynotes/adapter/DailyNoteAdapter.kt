package com.example.dailynotes.dailynotes.adapter
...
import com.example.dailynotes.dailynotes.ui.UpdateNoteActivity
...
class DailyNoteAdapter : RecyclerView.Adapter<DailyNoteAdapter.ViewHolder>(){
    private lateinit var binding: ItemNoteBinding
    private lateinit var context: Context
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DailyNoteAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: DailyNoteAdapter.ViewHolder, position: Int) {
